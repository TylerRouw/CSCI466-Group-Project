	...
	<?php if($placed === false) { ?>
		...
		<div style="width: fit-content; margin: auto;">
			...
			<form action="checkout.php" method="POST">
				...
				<label for="apartment" style="margin-left: 7px">Apt? </label>
				...
				<label for="cardExp" style="margin-left: 105px">Exp:</label><br/>
				<input type="text" name="cardNum" minlength="16" maxlength="16"required>
				<input type="text" name="cardExp" minlength="4" maxlength="4" size="1" style="margin-left: 20px" required><br/><br/>
				<label for="seCode">CVV:</label>
				<input type="text" name="seCode" size="1" minlength="3" maxlength="3" required>

				<label for="billzip" style="margin-left: 25px">Billing ZIP:</label>
				<input type="text" name="billzip" size="2" minlength="5" maxlength="10" required>
				<br/><br/>

				<h2 style="text-align: center"> Cart Contents</h2>
				...
				<p style="text-align: right; margin-right: 2.5%">Grand Total: $<?php echo $grandTotal?></p>

				<button type="submit" name="action" value="placeOrder" style="float: right; margin-right: 2.5%">Place Order!</button>
				<br/><br/>
			</form>

			<form action="<?php echo $_SESSION['usertype']?>_home.html" method="POST">
				<button type="submit" name="action" value="cancelOrder" style="float: right; margin-right: 2.5%">Cancel Order</button>
			</form>
		</div>
	<?php } else { ?>	
